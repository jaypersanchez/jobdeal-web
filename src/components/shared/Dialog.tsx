          ...
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <HeadlessDialog.Panel
                className={`w-full max-w-screen-${width} transform overflow-hidden rounded-xl bg-[#17181A] px-4 md:px-12 pb-4 dark:text-white text-left align-middle shadow-xl transition-all`}
              >
